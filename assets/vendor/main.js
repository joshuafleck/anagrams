...
var _user$project$Main$viewResult = function (result) {
	return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(result.requestedAt),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('card-subtitle mb-2 text-muted'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										...
										_elm_lang$core$Basics$toString(
											_elm_lang$core$List$length(result.anagrams)),
										A2(
											_elm_lang$core$Basics_ops['++'],
											' anagrams found for ',
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' in ',
													A2(_elm_lang$core$Basics_ops['++'], result.lookupTime, 'ms')))))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(_elm_lang$core$String$join, ' ', result.anagrams)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$allResults = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (result) {
			return _user$project$Main$viewResult(result);
		},
		model.results);
};
var _user$project$Main$Result = F4(
	function (a, b, c, d) {
		return {requestedAt: a, word: b, lookupTime: c, anagrams: d};
	});
var _user$project$Main$decodeAnagramResult = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Main$Result,
	A2(_elm_lang$core$Json_Decode$field, 'requestedAt', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'word', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'lookupTime', _elm_lang$core$Json_Decode$string),
	A2(
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {phxSocket: a, word: b, results: c};
	});
var _user$project$Main$AnagramsReceived = function (a) {
	return {ctor: 'AnagramsReceived', _0: a};
};
var _user$project$Main$RequestFailed = function (a) {
	return {ctor: 'RequestFailed', _0: a};
};
var _user$project$Main$requestAnagram = function (model) {
	var phxPush = A2(
		_fbonetti$elm_phoenix_socket$Phoenix_Push$onError,
		_user$project$Main$RequestFailed,
		A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Push$onOk,
			_user$project$Main$AnagramsReceived,
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
				_elm_lang$core$Json_Encode$string(model.word),
				A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'search', 'room:lobby'))));
	var _p0 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, phxPush, model.phxSocket);
	var phxSocket = _p0._0;
	var phxCmd = _p0._1;
	return {ctor: '_Tuple2', _0: phxSocket, _1: phxCmd};
};
var _user$project$Main$AnagramsRequested = {ctor: 'AnagramsRequested'};
var _user$project$Main$InputProvided = function (a) {
	return {ctor: 'InputProvided', _0: a};
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$form,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$AnagramsRequested),
						_1: {ctor: '[]'}
					}
				},
				{
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('Enter a word'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$InputProvided),
											_1: {
												ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					_user$project$Main$allResults(model)),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'AnagramsRequested':
				var _p4 = _user$project$Main$requestAnagram(model);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{word: '', phxSocket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, phxCmd)
				};
			case 'RequestFailed':
				var _p5 = A2(_elm_lang$core$Debug$log, 'failed to search for anagrams', _p2._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var decodeResult = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$decodeAnagramResult, _p2._0);
				...
				if (_p6.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								results: {ctor: '::', _0: _p6._0, _1: model.results}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p7 = A2(_elm_lang$core$Debug$log, 'anagram search failed', _p6._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
